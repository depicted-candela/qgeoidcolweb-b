"""
Django settings for qgeoidcolweb project.
...
SECRET_KEY = "django-insecure-9fu(t#tsbkioyzlgz-=$aap%^b)^%a)nrt82kkx6uw5rr%49^q"
...
WSGI_APPLICATION = "qgeoidcolweb.wsgi.application"
